...
def create_payment_pix():
    ...
    return jsonify({"message": "Payment PIX created successfully",
...
def pix_confirmation():
    ...
    if 'bank_payment_id' not in data and 'value' not in data:
        return jsonify({"error": "bank_payment_id and value are required"}), 400
...
# WebSocket to notify payment status
